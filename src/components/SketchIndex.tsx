...
export function SketchIndex<UC extends UniformControls>({ sketches }: {
    ...
    return <Box display="flex" gap="30px">
        ...
        <Box><Divider orientation="vertical"></Divider></Box>
        <SketchTable />
        <Spacer />
        <Spacer />
    </Box>;
